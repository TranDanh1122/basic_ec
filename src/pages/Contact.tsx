...
export default function Contact(): React.JSX.Element {
    ...
    return <>
        ...
        <div className="flex gap-8">
            <div className="space-y-8 w-1/3 shadow-lg p-8">
                ...
                <div className="font-medium space-y-4">
                    ...
                    <a className="text-sm" href="mailto:customer@exclusive.com">Emails: customer@exclusive.com</a>
                    <a className="text-sm" href="mailto:support@exclusive.com">Emails: support@exclusive.com</a>
                </div>
            </div>
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} id="checkout" className="flex flex-col gap-6 w-2/3 shadow-lg p-8">
